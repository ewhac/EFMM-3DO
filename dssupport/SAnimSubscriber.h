 ...
 */
#define	SANM_CHUNK_TYPE		CHAR4LITERAL('S','A','N','M')	/* chunk data type for this subscriber */
#define	AHDR_CHUNK_TYPE		CHAR4LITERAL('A','H','D','R')	/* chunk data type for this subscriber */
#define	ACCB_CHUNK_TYPE		CHAR4LITERAL('A','C','C','B')	/* chunk data type for this subscriber */
#define	FRME_CHUNK_TYPE		CHAR4LITERAL('F','R','M','E')	/* chunk data type for this subscriber */

#define	SANM_MAX_SUBSCRIPTIONS		2		/* max # of streams that can use this subscriber */
#define	SANM_MAX_CHANNELS			8		/* max # of logical channels per subscription */
...
typedef struct SAnimRec
	...
	struct StreamAnimCCB		saCCB;			/* Copy of the CCB chunk for this streamed anim */
	struct StreamAnimHeader		saHeader;		/* Copy of the Header chunk for this streamed anim */
...
int32	NewSAnimSubscriber( SAnimContextPtr *pCtx, int32 numChannels, int32 priority );
int32	DisposeSAnimSubscriber( SAnimContextPtr ctx );

int32	SendFreeSignal( SAnimContextPtr ctx );


int32	InitSAnimCel(	DSStreamCBPtr	streamCBPtr,
						SAnimContextPtr	ctx,
						SAnimRecPtr		*pSARecPtr,
						int32			channel,
						Boolean			flushOnSync);
						
void	FlushSAnimChannel( SAnimContextPtr ctx, SAnimRecPtr saRecPtr, int32 channel );
int32	DestroySAnimCel( SAnimContextPtr ctx, SAnimRecPtr saRecPtr, int32 channel );
